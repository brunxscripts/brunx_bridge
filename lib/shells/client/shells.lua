...
RegisterNetEvent('brnx_bridge:client:CreateShell', function(shell)
    Shells.New(shell)
end)

RegisterNetEvent('brnx_bridge:client:EnterShell', function(shellId, entranceId, oldId)
...
RegisterNetEvent('brnx_bridge:client:ExitShell', function(shellId, oldId)
    local shell = Shells.All[shellId]
...
RegisterNetEvent('brnx_bridge:client:AddObjectsToShell', function(shellId, interiorObjects, exteriorObjects)
    local shell = Shells.All[shellId]
...
RegisterNetEvent('brnx_bridge:client:CreateShells', function(shells)
...
-- TriggerClientEvent('brnx_bridge:client:ExitShell', src, oldId)
