...
function Shells.Create(data)
    ...
    TriggerClientEvent('brnx_bridge:client:CreateShell', -1, shell)
    return shell
end
...
function Shells.CreateBulk(shells)
    ...
    TriggerClientEvent('brnx_bridge:client:CreateShells', -1, toClient)
end
...
function Shells.Enter(src, shellId, entranceId)
    ...
    TriggerClientEvent('brnx_bridge:client:EnterShell', src, shellId, exit, Shells.ActivePlayers[tostring(src)])
...
function Shells.Exit(src, shellId, oldId)
    ...
    TriggerClientEvent('brnx_bridge:client:ExitShell', src, shellId, exit)
    return true
end
...
function Shells.AddObjects(shellId, objects)
    ...
    TriggerClientEvent('brnx_bridge:client:AddObjectsToShell', -1, shellId, shell.interior, shell.exterior)
    return shell
end
...
function Shells.RemoveObjects(shellId, objectIds)
    ...
    TriggerClientEvent('brnx_bridge:client:RemoveObjectsFromShell', -1, shellId, objectIds)
    return shell
end

RegisterNetEvent('brnx_bridge:server:EnterShell', function(shellId, entranceId)
    local src = source
    Shells.Enter(src, shellId, entranceId)
end)

RegisterNetEvent('brnx_bridge:server:ExitShell', function(shellId, oldId)
    local src = source
...
AddEventHandler('onPlayerJoining', function(playerId)
    local src = source
    TriggerClientEvent('brnx_bridge:client:CreateShells', src, Shells.All)
end)
...
AddEventHandler('brnx_bridge:Server:OnPlayerUnload', function(src)
