...
RegisterNetEvent("brnx_bridge:Client:Marker", function(data)
    Marker.Create(data)
end)

RegisterNetEvent("brnx_bridge:Client:MarkerBulk", function(datas)
...
RegisterNetEvent("brnx_bridge:Client:MarkerRemove", function(id)
    Marker.Remove(id)
end)

RegisterNetEvent("brnx_bridge:Client:MarkerRemoveBulk", function(ids)
