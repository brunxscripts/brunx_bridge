...
function Utility.CreateProp(model, coords, heading, networked)
    ...
    if not loaded then return nil, print("^6 brnx_bridge model was unable to load " .. tostring(model) .. " ^0") end
...
function Utility.CreateVehicle(model, coords, heading, networked)
    ...
    SetModelAsNoLongerNeeded(hash)
    return vehicle,
        { networkid = NetworkGetNetworkIdFromEntity(vehicle) or 0, coords = GetEntityCoords(vehicle), heading =
...
function Utility.FloatingHelpText(text, coords)
    AddTextEntry("brnx_bridge_" .. text, text)
    SetFloatingHelpTextWorldPosition(1, coords.x, coords.y, coords.z)
    SetFloatingHelpTextStyle(1, 1, 2, -1, 3, 0)
    BeginTextCommandDisplayHelp("brnx_bridge_" .. text)
...
function Utility.RegisterPoint(pointID, pointCoords, pointDistance, _onEnter, _onExit)
    print("^6 brnx_bridge ^: ^3Utility.RegisterPoint is deprecated. Please use Point.Register instead. ^0")
    return Point.Register(pointID, pointCoords, pointDistance, nil, _onEnter, _onExit)
end

function Utility.GetPointById(pointID)
    print("^6 brnx_bridge ^: ^3Utility.GetPointById is deprecated. Please use Point.Get instead. ^0")
    return Point.Get(pointID)
end

function Utility.GetActivePoints()
    print("^6 brnx_bridge ^: ^3Utility.GetActivePoints is deprecated. Please use Point.GetAll instead. ^0")
    return Point.GetAll()
end

function Utility.RemovePoint(pointID)
    print("^6 brnx_bridge ^: ^3Utility.RemovePoint is deprecated. Please use Point.Remove instead. ^0")
...
function Utility.CopyToClipboard(text)
    ...
    --TriggerEvent('brnx_bridge:Client:Notify', message, 'success')
    return true
end
