...
RegisterNetEvent('brnx_bridge:Client:openShop', function(shopType, shopLabel, shopData)
    ...
    local buildMenu = {
        {
            ...
            onSelect = function(_, __, ___)
                TriggerServerEvent('brnx_bridge:Server:completeCheckout', shopName, item, amount, "money")
            end
        },
        {
            ...
            onSelect = function(_, __, ___)
                TriggerServerEvent('brnx_bridge:Server:completeCheckout', shopName, item, amount, "bank")
            end
        }
    }
