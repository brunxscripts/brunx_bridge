...
Inventory.RegisterStash = function(id, label, slots, weight, owner, groups, coords)
    ...
    Inventory.Stashes[id] = { id = id, label = label, slots = slots, weight = weight, owner = owner, groups = groups, coords =
    coords }
    return true, id
end
...
Inventory.OpenPlayerInventory = function(src, targetSrc)
    return false,
        print(
        "OpenPlayerInventory is not implemented in this inventory, because of this we dont have a way to open a players inventory.")
end
