...
Inventory.AddItem = function(src, item, count, slot, metadata)
    ...
    local success = exports['jpr-inventory']:AddItem(src, item, count, slot, metadata, 'brnx_bridge Item added')
...
Inventory.RemoveItem = function(src, item, count, slot, metadata)
    local success = exports['jpr-inventory']:RemoveItem(src, item, count, slot, 'brnx_bridge Item removed')
    if not success then return false end
    TriggerClientEvent("brnx_bridge:client:inventory:updateInventory", src,
...
Inventory.OpenStash = function(src, _type, id)
    ...
    TriggerClientEvent('brnx_bridge:client:jpr-inventory:openStash', src, id, { weight = tbl.weight, slots = tbl.slots })
end
...
Inventory.RegisterShop = function(shopTitle, inventory, shopCoords, shopGroups)
    ...
    local repackItems = {}
    local repackedShopItems = { name = shopTitle, label = shopTitle, coords = shopCoords, items = repackItems, slots = #
    inventory, }
