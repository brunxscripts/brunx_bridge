...
Inventory.AddTrunkItems = function(identifier, items)
    ...
    return false,
        print(
        "AddItemsToTrunk is not implemented in core_inventory, because of this we dont have a way to add items to a trunk.")
end
...
---This will get the image path for an item, it is an alternate option to GetItemInfo. If a image isnt found will revert to brnx_bridge logo (useful for menus)
---@param item string
---@return string
