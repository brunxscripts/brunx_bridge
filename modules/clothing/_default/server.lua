...
function Clothing.GetAppearance(src)
    return Callback.Trigger('brnx_bridge:cb:GetAppearance', src)
end
...
function Clothing.SetAppearance(src, data)
    ...
    TriggerClientEvent('brnx_bridge:client:SetAppearance', src, data)
end
...
function Clothing.RestoreAppearance(src)
    TriggerClientEvent('brnx_bridge:client:RestoreAppearance', src)
end
